...
describe("delete notification", () => {
    ...
    it("success", async () => {
        ...
        //create dummy data
        const storeRes = await notificationService.storeNotification(authGuard, file, "wew1", "wew1 desc")

        //delete notif
        const res = await notificationService.deleteNotification(authGuard, storeRes.getData().id)
        console.log(res.getMessage())
    ...
    it("failed unauthorized", async () => {
        ...
        const res = await notificationService.deleteNotification(authGuard2, storeRes.getData().id)
        // console.log(res.getMessage())
